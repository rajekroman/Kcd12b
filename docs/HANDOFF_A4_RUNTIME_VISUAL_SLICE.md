...
- Strukturální boundary: world presentation je nyní izolována v `src/presentation/world/` s veřejným entrypointem `index.ts`; runtime importuje pouze tento boundary modul.
